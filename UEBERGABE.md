...
Stand: **v1.5.271** · index.html 2,41 MB · 689 Funktionen
...
Startseite „heute nicht gießen" (v1.5.267). Die stehende Pflanze heißt „Ernte offen" (v1.5.269). IceFlush und Dunkelphase stehen nicht mehr im Stadium „Trocknung" (v1.5.271). Offen, in dieser Reihenfolge: ein eingetragener Guss zählt als erledigt · Gießpunkt schlägt Kalender
