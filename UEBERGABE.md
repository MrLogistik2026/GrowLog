...
Stand: **v1.5.207** · index.html 2,34 MB · 672 Funktionen
...
### 0m.1 · Gießmenge — entschieden und umgesetzt (v1.5.200–207)
...
Plan (203), eine Waage-Skala (204), Gießmenge aus dem Topf (205), heute gießen bei schnell trocknendem Topf (206), eine Klimafunktion (207). Die Fragen (a)–(e) sind damit beantwortet: fester Gießpunkt
...
**Noch offen, in dieser Reihenfolge** (Plan der Prüfung, Schritte 11–12):
1. **Restliche Texte:** Einstellungen zeigen V als Topf-Eigenschaft und fragen nach dem gefüllten Volumen (aufgehäuft 14–16 L
...
2. **ANBAU.md** 1.1 („Wann und wie viel"), 1.2 (Gießpunkt als Hebe-Skala mit Anker), 5.1 (Drain-Ziel mit Belegen), 7.5
...
1. **Gießmenge: die Restschritte in 0m.1** (restliche Texte, ANBAU.md).
...
109 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
