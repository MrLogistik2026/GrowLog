...
Stand: **v1.5.209** · index.html 2,34 MB · 676 Funktionen
...
1. **Drain-EC-Texte und Spülende** (Begriffe-Prüfung Schritt 5 und 7, `scratchpad/agenten3/begriffe2.json` unter `umsetzung`): alle festen Drain-EC-Deutungen in Lexikon, Infotexten und Vorlagen aus `DRAIN_EC_VERHAELTNIS`; kein „Drain-EC ≤ 0,4" mehr als Spülende.
2. **Erntefenster:** drei Messpunkte (Headbud, Mitte, unten), gemittelt; Ernte bei 5–8 % Bernstein, auch wenn noch klare Köpfe da sind, einstellbar (Befunde in 0m.2).
3. **Keimungs-Zahlen** mit Quelle vereinheitlichen (Befund weiter unten).
4. **Düngepläne:** BioBizz-Schema nachschlagen, Wasser-Tage als Wahl des Nutzers, Herstellerpläne nach Genetik und Dauer (0m.4).
...
111 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
