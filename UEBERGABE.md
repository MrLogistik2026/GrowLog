...
Stand: **v1.5.187** · index.html 2,30 MB · 663 Funktionen
...
Tipps-Zone und Lexikon-Hinweis; `ANBAU.md` 2.2 neu). **Noch offen, in dieser Reihenfolge:** VPD-Diagramm (Zone fest
0,8–1,2, Text „Spätblüte 1.4–1.6") und die festen Klimazahlen in Lexikon, Tipps-Karte `T.vpd`, `PROBLEMS` und
Notiz-Vorschlägen; der Diagnose-Kontext „Luftfeuchte hoch" aus dem Befund; der Klimafaktor der Gießmenge nach Oren
...
90 Testdateien (Gesamtlauf auf v1.5.185 grün, beide Zeitzonen, 176 Läufe; seit v1.5.186 die betroffenen) — neu dazu
