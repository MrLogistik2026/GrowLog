...
Stand: **v1.5.197** · index.html 2,31 MB · 671 Funktionen
...
- **Beim Abarbeiten von v1.5.197 gesehen:** Die Diagnose „Überwässerung" (`PROBLEMS`, id `overwatering`) rät „Mehrere
  Tage pausieren, dann kleinere Mengen". In einem Topf mit Abfluss macht nicht die Menge je Guss nass, sondern zu häufiges
  Gießen oder ein voller Untersetzer (Mengenbilanz, `ANBAU.md` 1). Im Umbau zusammen mit dem Hinweis „Topf war noch
  feucht" aus der Prüfer-Korrektur neu fassen.
...
99 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
