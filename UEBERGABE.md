...
Stand: **v1.5.240** · index.html 2,38 MB · 679 Funktionen
...
- **Fish·Mix zusätzlich oder statt Bio·Grow?** Das Blatt 2026 führt beide mit denselben Mengen, ohne „oder"; das
  Fish·Mix-Datenblatt (2021) nennt es einen Ersatz in der Wachstumsphase, die Produktseite sagt nichts. Die
  Vorlage führt nur Bio·Grow (sichere Seite). Klärbar mit einer Anfrage bei BioBizz.
