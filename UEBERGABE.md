...
Stand: **v1.5.250** · index.html 2,38 MB · 680 Funktionen
...
`test_outdoor` (29), `test_diagnose` (38), `test_lexikon` (79), `test_kalender` (23), `test_ernte_iceflush` (35), `test_rainbowplan` (61), `test_planumhaengen` (17),
...
- **Noch unbelegte Aussagen in den Einträgen „Bio vs. Mineralisch" und „Spülung"** (beim Durchgang v1.5.248/249 gesehen,
  bewusst nicht mitgenommen — keine Dosis- und keine Geschmacksfrage): „Maximaler Ertrag: Bio etwas niedriger", „Bio-Dünger
  in Coco → Bio-Wirkung halbiert", „Mineral in Living Soil → Boden stirbt", „Bei Living Soil trotzdem spülen → zerstört das
  mikrobielle Gleichgewicht", „Bio … extrem fehlerverzeihend"; im NPK-Eintrag „K für Zuckereinlagerung und Trichom-Bildung",
  „K für finalen Reife-Push". Gehört in die Begriffe-Prüfung (Schritte 8–24, Wirkungszusagen).
