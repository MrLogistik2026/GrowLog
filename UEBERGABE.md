...
Stand: **v1.5.189** · index.html 2,31 MB · 664 Funktionen
...
Tipps-Zone und Lexikon-Hinweis; `ANBAU.md` 2.2 neu) und v1.5.188 (Dunkelphase und Erntetag ohne Band, nur der Deckel) und v1.5.189 (das abgeschaltete VPD-Diagramm je Phase).
**Noch offen, in dieser Reihenfolge:** die festen Klimazahlen in Lexikon, Tipps-Karte `T.vpd`, `PROBLEMS` und
...
92 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
