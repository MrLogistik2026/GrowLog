...
Stand: **v1.5.213** · index.html 2,35 MB · 676 Funktionen
...
1. **Keimung, restliche Schritte** (Keimungs-Prüfung: `scratchpad/agenten2/ergebnis_keimung_Vorschlagen.json` unter `umsetzung`; Schritte 1, 2, 10 und 11 erledigt in v1.5.213). Vorrang vor dem Erntefenster, weil Run 02 damit beginnt: Standard-Keimmethode „Direkt" (Schritt 3), Sämlings-Pflege Tag 3–7 (4), Gieß-Tipp nach Aktion statt nach Tag (5), Sprüh-Auslöser an der Erde am Samen statt „obere 1–2 cm" (6), Tag-1-Texte und „an Tag 9 ohne Keimling nicht gießen" (7, 8), Keimphase bis Tag 7 (9), Lexikon Sämlingsphase und Haube (12, 13), Hilfe-Text zum Startdatum (14), Assistent-Knopf „Ohne Vorbefeuchten" (15), Demo-Zyklus (16), `ANBAU.md` 16 (17).
2. **Erntefenster:** drei Messpunkte (Headbud, Mitte, unten), gemittelt; Ernte bei 5–8 % Bernstein, auch wenn noch klare Köpfe da sind, einstellbar (Befunde in 0m.2). Plan der Prüfung: `scratchpad/agenten2/ergebnis_erntefenster_Vorschlagen.json` unter `umsetzung` (9 Schritte). Schritt 1 ist erledigt (v1.5.212); als Nächstes Schritt 2 — Rechenwerte kennzeichnen (`q`: gezählt, bestätigt, gerechnet) und aus Prognose und Freigabe halten.
3. **Düngepläne:** BioBizz-Schema nachschlagen, Wasser-Tage als Wahl des Nutzers, Herstellerpläne nach Genetik und Dauer (0m.4).
4. **Begriffe-Prüfung, Schritte 8–24** (`scratchpad/agenten3/begriffe2.json` unter `umsetzung`): Wirkungszusagen und Dosen in Texten, ein Wächter-Test für verbotene Formen, zuletzt die Umbenennungen (Runoff/Ablauf → Drain, Input → Gießwasser).
...
114 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
