...
Stand: **v1.5.210** · index.html 2,34 MB · 676 Funktionen
...
1. **Spülende ohne Drain-EC-Schwelle** (Begriffe-Prüfung Schritt 7, `scratchpad/agenten3/begriffe2.json` unter `umsetzung`): kein „Drain-EC ≤ 0,4" mehr in IceFlush-Checkliste, Lexikon und Vorlagen — unter den EC des Spülwassers kann der Drain nicht fallen, in Erde steigt er danach wieder; das Spülende setzt der Plan.
...
112 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
