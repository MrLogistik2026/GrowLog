...
Stand: **v1.5.270** · index.html 2,41 MB · 689 Funktionen
...
Startseite „heute nicht gießen" (v1.5.267). Die stehende Pflanze heißt „Ernte offen" (v1.5.269). Offen, in dieser Reihenfolge: IceFlush im Stadium „Trocknung" · ein eingetragener Guss zählt als erledigt · Gießpunkt schlägt Kalender
