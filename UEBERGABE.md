...
Stand: **v1.5.219** · index.html 2,35 MB · 677 Funktionen
...
1. **Keimung, restliche Schritte** (Keimungs-Prüfung: `scratchpad/agenten2/ergebnis_keimung_Vorschlagen.json` unter `umsetzung`; Schritte 1–11 erledigt in v1.5.213–219). Vorrang vor dem Erntefenster, weil Run 02 damit beginnt: Lexikon Sämlingsphase und Haube (12, 13), Hilfe-Text zum Startdatum (14), Assistent-Knopf „Ohne Vorbefeuchten" (15), Demo-Zyklus (16), `ANBAU.md` 16 (17).
