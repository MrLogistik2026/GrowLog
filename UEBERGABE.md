...
Stand: **v1.5.188** · index.html 2,30 MB · 663 Funktionen
...
Tipps-Zone und Lexikon-Hinweis; `ANBAU.md` 2.2 neu) und v1.5.188 (Dunkelphase und Erntetag ohne Band, nur der Deckel).
**Noch offen, in dieser Reihenfolge:** VPD-Diagramm (Zone fest
0,8–1,2, Text „Spätblüte 1.4–1.6") und die festen Klimazahlen in Lexikon, Tipps-Karte `T.vpd`, `PROBLEMS` und
Notiz-Vorschlägen (dazu im Lexikon-Eintrag „Dunkelphase vor der Ernte" 16–19 °C und 40–50 % ohne Quelle und „Cannabinoide
nachts hochgepumpt", im Dunkelphasen-Banner „produziert auf Hochtouren Trichome"); der Diagnose-Kontext „Luftfeuchte hoch" aus dem Befund; der Klimafaktor der Gießmenge nach Oren
(mit dem Gießmengen-Umbau, bis dahin `_vpdFaktorBand`). Die Befunde unten beschreiben den Stand vor v1.5.187.
...
91 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
