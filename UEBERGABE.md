...
Stand: **v1.5.190** · index.html 2,31 MB · 671 Funktionen
...
**Noch offen, in dieser Reihenfolge:** (1) Die Tag-Nacht-Differenz ist im Lexikon verdreht („hohe Differenz =
stauchere Pflanze" — belegt ist das Gegenteil, Carvalho et al. 2002, Ann Bot 90:111), dazu kühle Nächte: FAQ „10–15 °C
in der späten Blüte", Anthocyane „Temperaturdifferenz ist der Schlüssel" (bei Cannabis färbten gleichmäßig 8–15 °C am
stärksten, Wechsel weniger; Ertrag und CBD am höchsten bei 22 °C — Kim et al. 2025, J Cannabis Res), Kältestress
„Phosphor-Lockout unter 18 °C" gegen `ANBAU.md` 7.3 (Wurzelzone unter 16 °C). (2) Unbelegte Zusagen um IceFlush,
Dunkelphase und Ernte: „Cannabinoide nachts hochgepumpt" (Lexikon, zweimal), „der Trichom-Effekt funktioniert trotzdem",
„produziert auf Hochtouren Trichome" (Dunkelphasen-Banner), „Salze werden ausgespült" und „Drain-EC nach dem Schmelzen
< 0,4" beim IceFlush in den trockenen Topf. (3) Der Diagnose-Kontext „Luftfeuchte hoch" aus dem Befund (Sämling bei
74 % meldet „hoch", sein Ziel ist 62–75 %). (4) Temperatur-Warnungen beim Trocknen („Phosphor-Lockout droht" bei
17 °C). (5) Die Outdoor-VPD-Etiketten rechnen noch mit den alten Bändern — gehört in den Outdoor-Bereich. (6) Der
Klimafaktor der Gießmenge nach Oren (mit dem Gießmengen-Umbau, bis dahin `_vpdFaktorBand`). Die Befunde unten beschreiben den Stand vor v1.5.187.
...
93 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
