...
Stand: **v1.5.291** · index.html 2,45 MB · 751 Funktionen
...
- **Punkte 2 und 3 erledigt (v1.5.290):** Ein unbrauchbarer Hauptstand wird aufgehoben (`growsmart_v4_rettung`), die
  ...
  Test `test_rettung.js` (71 Prüfungen, beide Zeitzonen; 21 fallen auf v1.5.289 um, 11 auf v1.5.290).
- **v1.5.291 räumt sieben Befunde der Prüfer an v1.5.290 ab**, vier davon schlechter als der Vorgänger
  (Einzelheiten im CHANGELOG). Die Lehre gehört in jede weitere Speicher-Version: **Jede Sperre braucht eine
  Tür.** Der Schutz hielt das Speichern an und blockierte damit genau den Weg, den die App selbst empfahl —
