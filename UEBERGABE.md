...
Stand: **v1.5.151** · index.html 2,26 MB · 638 Funktionen
...
`_zyklusFuerPlan`). · Schimmel-Alarm ab 60 % RLF auch beim Spülen und am IceFlush (v1.5.149). · Drain-EC ohne Ablaufmenge wird nicht bewertet, das Etikett beschreibt statt zu deuten (v1.5.150). · Ernte-Hinweis ohne „bernsteinfarben = Peak" (v1.5.151).
...
2. Trocknungs-VPD rät
   „RLF runter"; Erntefenster aus stagnierendem Bernstein;
   ...
   Luftfeuchte; Demo-Zyklus; Sorten-Chip im Assistenten.
...
59 Testdateien (Gesamtlauf auf v1.5.147 grün; seit v1.5.148 die betroffenen) — neu dazu
...
`test_wochentipp` (17), `test_assistentplan` (33), `test_kopfkarte` (12), `test_zuweisungskarte` (10), `test_ecziel` (20), `test_bluetestufen` (14), `test_einsteigersatz` (11), `test_iceflushtexte` (13), `test_zweiplaene` (11), `test_dauerdruecken` (10), `test_giessluecke` (19), `test_planblattwoche` (12), `test_schimmelspuelen` (14) und `test_drainohnemenge` (23):
