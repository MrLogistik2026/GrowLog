...
Stand: **v1.5.217** · index.html 2,35 MB · 677 Funktionen
...
1. **Keimung, restliche Schritte** (Keimungs-Prüfung: `scratchpad/agenten2/ergebnis_keimung_Vorschlagen.json` unter `umsetzung`; Schritte 1–6, 10 und 11 erledigt in v1.5.213–217). Vorrang vor dem Erntefenster, weil Run 02 damit beginnt: Tag-1-Texte und „an Tag 9 ohne Keimling nicht gießen" (7, 8), Keimphase bis Tag 7 (9), Lexikon Sämlingsphase und Haube (12, 13), Hilfe-Text zum Startdatum (14), Assistent-Knopf „Ohne Vorbefeuchten" (15), Demo-Zyklus (16), `ANBAU.md` 16 (17).
