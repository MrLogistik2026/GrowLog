...
Stand: **v1.5.273** · index.html 2,41 MB · 691 Funktionen
...
Startseite „heute nicht gießen" (v1.5.267), auch am Spültag (v1.5.272). Die stehende Pflanze heißt „Ernte offen" (v1.5.269). IceFlush und Dunkelphase stehen nicht mehr im Stadium „Trocknung" (v1.5.271). Ein eingetragener Guss zählt als erledigt (v1.5.273). Offen, in dieser Reihenfolge: Gieß-Fahrplan „Nächster Guss" nach dem Guss und bei vollem Topf · Gießpunkt schlägt Kalender
