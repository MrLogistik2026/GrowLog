...
Stand: **v1.5.212** · index.html 2,35 MB · 676 Funktionen
...
2. **Keimungs-Zahlen** mit Quelle vereinheitlichen (Befund weiter unten).
...
113 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
