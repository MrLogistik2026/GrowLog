...
Stand: **v1.5.152** · index.html 2,27 MB · 638 Funktionen
...
`_zyklusFuerPlan`). · Schimmel-Alarm ab 60 % RLF auch beim Spülen und am IceFlush (v1.5.149). · Drain-EC ohne Ablaufmenge wird nicht bewertet, das Etikett beschreibt statt zu deuten (v1.5.150). · Ernte-Hinweis ohne „bernsteinfarben = Peak" (v1.5.151). · Trocknungsklima aus einer Quelle, beim Trocknen kein VPD-Rat „RLF runter" mehr (v1.5.152, `TROCKNEN_KLIMA`).
...
60 Testdateien (Gesamtlauf auf v1.5.147 grün; seit v1.5.148 die betroffenen) — neu dazu
