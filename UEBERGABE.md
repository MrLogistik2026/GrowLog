...
Stand: **v1.5.292** · index.html 2,45 MB · 751 Funktionen
...
- **Punkte 2 und 3 erledigt (v1.5.290):** Ein unbrauchbarer Hauptstand wird aufgehoben (`growsmart_v4_rettung`), die
  ...
  Test `test_rettung.js` (84 Prüfungen, beide Zeitzonen; 21 fallen auf v1.5.289 um, 11 auf v1.5.290, 8 auf v1.5.291).
