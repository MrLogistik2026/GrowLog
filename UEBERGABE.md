...
Stand: **v1.5.265** · index.html 2,40 MB · 686 Funktionen
...
**Stand Hebel 1:** Der Erntetag folgt der Trichom-Messung (v1.5.264), und eine stehende Pflanze nach dem Plan-Erntetag gilt
nicht mehr als geerntet (v1.5.265, `ernteOffen`). Offen, in dieser Reihenfolge: Das Klima im Eintrag bewertet eine stehende
Pflanze nach dem Plan-Erntetag nicht (`klimaStufe(p)` ohne Zyklus, also kein Schimmel-Deckel) · voller Topf und 0 ml auf
Satz und Karte · ein eingetragener Guss zählt als erledigt · Gießpunkt schlägt Kalender (Nachholen, überfällig, nächster
Guss mit Reserve) · IceFlush als Eistag in Gieß-Fahrplan, Tipp und Mitteilung · alle Pflanzen einzeln geerntet ·
Ernte-Kacheln nennen die Messung.
