...
Stand: **v1.5.168** · index.html 2,28 MB · 640 Funktionen
...
**Beim Abarbeiten von v1.5.168 gesehen, als Nächstes (Fehler, eigene Versionen):** (a) Die Keimungs-Zahlen widersprechen sich: Keimwurzel beim Einsetzen 2–3 mm (Lexikon) · 2–5 mm (Anleitung) · 0,5–1 cm (Keimungskarte, `GERM_GUIDES`); Wasserglas höchstens 32 h (Karte) gegen 48 h (Lexikon); Keimling in der Erde nach 3–7 Tagen (Karte) gegen 5–10 Tage (Lexikon) gegen „Tag 3–5" (Anleitung). (b) Assistent und Einstellungen nennen beim Sämlings-Start noch feste Mengen („~700 ml", „~400 ml", „150ml Erstguss"), obwohl Tag 1 seit v1.5.161 aus Topf und Substrat rechnet.
...
71 Testdateien (Gesamtlauf auf v1.5.165 grün, beide Zeitzonen; seit v1.5.166 die betroffenen) — neu dazu
