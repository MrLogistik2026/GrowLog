...
Stand: **v1.5.192** · index.html 2,31 MB · 671 Funktionen
...
**Noch offen, in dieser Reihenfolge:** (1) Der Diagnose-Kontext „Luftfeuchte hoch" aus dem Befund (Sämling bei 74 %
meldet „hoch", sein Ziel ist 62–75 %). (2) Temperatur-Warnungen beim Trocknen und im Curing: Sie sprechen von Wachstum
und Wurzelzone, obwohl die Pflanze geschnitten ist. (3) Die Outdoor-VPD-Etiketten rechnen noch mit den alten Bändern —
gehört in den Outdoor-Bereich. (4) Der Klimafaktor der Gießmenge nach Oren (mit dem Gießmengen-Umbau, bis dahin
`_vpdFaktorBand`). Die Befunde unten beschreiben den Stand vor v1.5.187.
...
95 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
