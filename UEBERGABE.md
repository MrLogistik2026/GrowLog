...
Stand: **v1.5.215** · index.html 2,35 MB · 676 Funktionen
...
1. **Keimung, restliche Schritte** (Keimungs-Prüfung: `scratchpad/agenten2/ergebnis_keimung_Vorschlagen.json` unter `umsetzung`; Schritte 1, 2, 3, 6, 10 und 11 erledigt in v1.5.213–215). Vorrang vor dem Erntefenster, weil Run 02 damit beginnt: Sämlings-Pflege Tag 3–7 (4), Gieß-Tipp nach Aktion statt nach Tag (5), Tag-1-Texte und „an Tag 9 ohne Keimling nicht gießen" (7, 8), Keimphase bis Tag 7 (9), Lexikon Sämlingsphase und Haube (12, 13), Hilfe-Text zum Startdatum (14), Assistent-Knopf „Ohne Vorbefeuchten" (15), Demo-Zyklus (16), `ANBAU.md` 16 (17).
