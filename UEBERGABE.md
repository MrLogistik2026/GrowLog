...
Stand: **v1.5.208** · index.html 2,34 MB · 674 Funktionen
...
1. **Drain-EC als Verhältnis** zum Zulauf-EC bewerten statt als feste Zahl (`ANBAU.md` 5.1, Tabelle „Verhältnis Drain zu Zulauf"; `analyzeRunoff`).
...
110 Testdateien (Gesamtlauf auf v1.5.187 grün, beide Zeitzonen, 180 Läufe; seit v1.5.188 die betroffenen) — neu dazu
