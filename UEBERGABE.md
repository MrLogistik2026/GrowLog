...
Stand: **v1.5.266** · index.html 2,40 MB · 687 Funktionen
...
nicht mehr als geerntet (v1.5.265, `ernteOffen`). Das Klima einer stehenden Pflanze folgt der späten Blüte (v1.5.266). Offen, in dieser Reihenfolge: voller Topf und 0 ml auf
