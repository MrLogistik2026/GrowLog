...
Stand: **v1.5.246** · index.html 2,38 MB · 680 Funktionen
...
- **Wie die App über Herstellermengen spricht — neun Stellen, eine Haltung ohne Beleg** (gefunden am 16.09.2026 beim
  Aufräumen des Lexikon-Eintrags „Düngepläne"). Lexikon, Tipps und die Vorlage `biobizz_konservativ` sagen
  „Hersteller geben Maximalwerte an", „50–70 % sind robuster", „garantiertes Salzaufbau-Risiko". Im Lexikon-Vergleich
  passt die eigene Tabelle nicht einmal zur Prozentzahl (Bio·Grow 2–4 → 0,5–0,8 ml/L sind 20–25 %); dazu eine feste
  Drain-EC-Schwelle „unter 1.8" (Fehlerklasse v1.5.209/210) und „Bio: terpenreicher" beim Geschmack (`ANBAU.md` 14).
  Seit v1.5.240 führt die App eine Vorlage mit den Herstellermengen — die Texte widersprechen dem ohne Beleg.
  **Als eigener Durchgang wie v1.5.228**, nicht Stelle für Stelle. Suchmuster:
  `Hersteller-Maxima|50–70|Maximalwerte|Salzaufbau|terpenreicher|Drain-EC unter 1`. Vorschlag für die Haltung: Die
  Tabelle des Herstellers gilt für seine Bedingungen; was die Pflanze verträgt, zeigen Blattspitzen und Drain; die App
  führt Herstellervorlagen und sanftere für den Einstieg — bei Unsicherheit weniger (`ANBAU.md` 15).
